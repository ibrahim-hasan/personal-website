...
return [
    'index' => [
        ...
        'result_count' => '{0} No articles|{1} :count article|[2,*] :count articles',
        'filtered_empty_eyebrow' => 'Selected topic',
        'filtered_empty_title' => 'There are no articles in this topic yet.',
        'filtered_empty_body' => 'Try another topic or return to all articles.',
    ...
    'reader' => [
        ...
        'continue_reading' => 'Return to article',
        ...
        'related_projects' => 'Related case studies',
        'source_linkedin' => 'Read the original version on LinkedIn',
        'minutes' => '{0} Less than a minute read|{1} :count min read|[2,*] :count min read',
    ],
    'share' => [
        'label' => 'Share article',
