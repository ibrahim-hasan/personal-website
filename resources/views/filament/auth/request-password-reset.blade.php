    ...
    <section class="fi-auth-shell__section px-6 py-8 sm:px-10 sm:py-10 flex items-center justify-center flex-col relative z-10">
        ...
        <div class="w-full max-w-md">
            <div class="fi-auth-shell__card">
                <h2 class="fi-auth-shell__heading !mb-2">{{ __('Forgot your password?') }}</h2>
                <p class="fi-auth-shell__subtext mb-6">{{ __('No problem. Enter your email and we will send you a password reset link.') }}</p>
