...
<head>
    ...
    <title>{{ __('mail.guide_download_subject') }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#2c2c2d;border:1px solid #857a54;border-radius:12px;overflow:hidden;">
                    <tr>
                        <td style="padding:28px 24px;background:linear-gradient(120deg,#2c2c2d 0%,#414042 100%);text-align:center;">
                            <h1 style="margin:0;color:#e4ddc4;font-size:28px;line-height:1.4;font-weight:700;">
                                {{ __('mail.guide_download_heading') }}
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px 24px;">
                            ...
                            @else
                            <p style="margin:0 0 24px 0;color:#f1c4c4;font-size:14px;line-height:1.8;text-align:center">
                                {{ __('mail.guide_download_link_missing') }}
                            </p>
                            @endif

                            <p style="margin:0;color:#d8d5c8;font-size:13px;line-height:1.5;text-align:center">
                                {{ __('mail.guide_download_expiry_note') }}
                            </p>
                        </td>
                    </tr>
