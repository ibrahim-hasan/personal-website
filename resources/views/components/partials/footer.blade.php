        ...
        <section class="site-footer__cta">
            <div class="site-container site-footer__cta-layout">
                ...
                <a
                    ...
                    wire:navigate
                    class="button-light site-footer__cta-action"
                    data-magnetic
                    data-analytics-event="primary_cta_click"
                    data-analytics-ui-location="footer_cta"
