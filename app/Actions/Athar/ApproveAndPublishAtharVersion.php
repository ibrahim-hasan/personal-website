        ...
        $record->contribution
            ...
            ->each(function (AtharPublicationVersion $previous) use ($request, $invitation): void {
                ...
                $previous->consentEvents()->create([
                    ...
                    'verification_method' => AtharAccess::verificationMethod($invitation, $request),
