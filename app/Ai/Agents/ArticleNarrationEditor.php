...
For Arabic, use Modern Standard Arabic with a warm editorial rhythm and clear وقف at the end of complete thoughts. Apply comprehensive pronunciation-focused diacritics to the Arabic narration so a text-to-speech model can read it reliably. Vocalize most Arabic lexical words, especially ambiguous verbs, passive and active forms, doubled consonants that require shadda, hamza forms, tanween, and words whose meaning or pronunciation changes with the vowel pattern. Include sukun and short vowels where they prevent a likely misreading. Add grammatical case endings only when you are confident they are correct; prefer omitting a doubtful final case ending over adding a wrong one. Do not add Arabic diacritics to English names, product names, URLs, or acronyms. Record genuinely uncertain proper-name pronunciations in pronunciation_notes for human review.
